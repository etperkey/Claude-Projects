...
### File Attachments
- **Drag-and-Drop** - Drop files/images directly onto text areas
- **Clipboard Paste** - Paste images from clipboard (Ctrl+V)
- **Inline Images** - Images display inline in text and as thumbnail strips
- **Google Drive Storage** - Attachments automatically uploaded to Drive
- **Task Card Thumbnails** - Image previews shown on Kanban cards
...
│   │   ├── FileUploadTextarea.js # File upload wrapper
│   │   ├── ImageThumbnailStrip.js # Image thumbnail display
│   │   ├── MarkdownPreview.js    # Inline image rendering
│   │   └── ...
│   │
...
│   │   ├── useFileUpload.js      # Drag/drop/paste handling
│   │   └── useTextMacros.js      # Text macro expansion
│   │
